<div class="quick-search" x-data="quickSearch()" x-on:keydown.escape.window="clearSearch()">
    <div class="quick-search__inputs">
        <input
            ...
            type="text"
            placeholder="Szukaj — nazwa i rok albo adres TMDB / IMDB"
            x-model="searchText"
            ...
            x-on:keydown.enter.prevent="if(searchText) window.location='{{ route('torrents.index') }}?name='+encodeURIComponent(searchText)"
        />
        <button
            type="button"
            class="quick-search__submit"
            x-on:click="if(searchText) window.location='{{ route('torrents.index') }}?name='+encodeURIComponent(searchText)"
        >Szukaj</button>
