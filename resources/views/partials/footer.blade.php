<footer class="footer">
    <div class="footer__wrapper">
        <section class="footer__section">
            ...
            <p class="footer__tagline">Sharing is not a crime &mdash; its a culture.</p>
    ...
    <div class="footer__sub-footer">
        ...
        <p class="footer__copyright">
            <span class="footer__copy-sep">&bull;</span>
            <a class="footer__esej" data-text="Esejowsky" href="https://cutty.dev" target="_blank" rel="noopener noreferrer">Esejowsky</a>
            dla <span class="footer__pt">Polish Torrent</span>
            <span class="footer__copy-year">&copy; {{ date('Y') }}</span>
        </p>
    </div>
</footer>
